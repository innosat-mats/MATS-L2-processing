...
def main():
    ...
    fwdm = Forward_model_basic_lin(conf, const, grid, obs, combine_images=True)
    ...
    solver = Linear_solver(fwdm, obs_data, conf, Sa_inv, Se_inv, atm_apr, fname=f"{args.prefix}")
